...
| Sun glare from the planets | **Illustrative** | The Sun is drawn at its true size seen from each planet; the glow and short twinkling rays around it are a camera-style glare so a disc that small reads as blinding. |
